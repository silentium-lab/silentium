 ...
 */
declare const source: <T>(source: SourceType<T>) => (guest: GuestType<T>) => void;
 ...
 */
declare function give<T>(data: T, guest?: GuestType<T>): GuestType<T> | SourceExecutorType<T>;
/**
